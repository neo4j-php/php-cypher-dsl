...
class RelationshipTest extends TestCase
{
    ...
    {
        return [
            ['', 1, 100, Relationship::DIR_LEFT, '(a)<-[*1..100]-(b)'],
            ['a', 10, null, Relationship::DIR_LEFT, '(a)<-[:a*10..]-(b)'],
            [':', null, 10, Relationship::DIR_LEFT, '(a)<-[:`:`*..10]-(b)']
        ];
    }
    ...
    {
        return [
            [[], 10, 100, Relationship::DIR_LEFT, "(a)<-[*10..100 {}]-(b)"],
            [[new StringLiteral('a')], 10, null, Relationship::DIR_LEFT, "(a)<-[*10.. {`0`: 'a'}]-(b)"],
            [['a' => new StringLiteral('b')], null, 10, Relationship::DIR_LEFT, "(a)<-[*..10 {a: 'b'}]-(b)"]
        ];
    }
