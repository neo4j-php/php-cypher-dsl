 ...
 *
 * @see https://neo4j.com/docs/cypher-manual/current/functions/predicate/#functions-none Corresponding documentation on Neo4j.com
 * @see Procedure::none()
 */
final class None extends Procedure implements BooleanType
{
    ...
    /**
     * The signature of the "none()" function is "none(variable :: VARIABLE IN list :: LIST OF ANY? WHERE predicate :: ANY?) :: (BOOLEAN?)".
     *
